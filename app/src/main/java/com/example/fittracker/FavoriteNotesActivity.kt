...
class FavoriteNotesActivity : UniSyncActivity() {

    private lateinit var binding: ActivityCollapsibleNotesBinding
    private var recentExpanded: Boolean = false
    private var favoriteExpanded: Boolean = true
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.header.headerTitle.text = "Favorite Notes"
